...
export class ChangePasswordComponent implements OnInit {
    ...
    constructor(private httpClientService: HttpClientService, private toastrHelperService: ToastrHelperService, private authenticationService: AuthenticationService) {
    }
